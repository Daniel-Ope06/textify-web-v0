...
export class BirthdayGiftComponent {
  ...
  baseColor: string = '#2C4251';
  roseColor: string = '#6B0504';
  outlineColor: string = '#0B2027';
  stemColorBase: string = '#7A9E7E';
  stemColorDark: string = '#7FB069';
  stemColorLight: string = '#31493C';

  lineColors: string[][] = [
    new Array(12).fill(this.baseColor)
      .concat(new Array(6).fill(this.outlineColor))
      .concat(new Array(2).fill(this.baseColor))
      .concat(new Array(4).fill(this.outlineColor))
      .concat(new Array(6).fill(this.baseColor)),

    new Array(10).fill(this.baseColor)
      .concat(new Array(4).fill(this.outlineColor))
      .concat(new Array(2).fill(this.roseColor))
      .concat(new Array(4).fill(this.outlineColor))
      .concat(new Array(4).fill(this.roseColor))
      .concat(new Array(2).fill(this.outlineColor))
      .concat(new Array(4).fill(this.baseColor)),

    new Array(4).fill(this.baseColor)
      .concat(new Array(6).fill(this.outlineColor))
      .concat(new Array(4).fill(this.roseColor))
      .concat(new Array(2).fill(this.outlineColor))
      .concat(new Array(4).fill(this.roseColor))
      .concat(new Array(8).fill(this.outlineColor))
      .concat(new Array(2).fill(this.baseColor)),

    new Array(2).fill(this.baseColor)
      .concat(new Array(2).fill(this.outlineColor))
      .concat(new Array(6).fill(this.roseColor))
      .concat(new Array(2).fill(this.outlineColor))
      .concat(new Array(4).fill(this.roseColor))
      .concat(new Array(4).fill(this.outlineColor))
      .concat(new Array(6).fill(this.roseColor))
