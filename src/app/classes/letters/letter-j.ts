...
export class LetterJ implements CharacterInterface {
    oooo: string = "    ";
    llll: string = "$$$$";
    ...
    getLine(lineNumber: number): string{
        let line: string = "";
        switch(lineNumber){
            case 0: line = this.oooo + this.oooo + this.llll + this.oooo; break;
            case 1: line = this.oooo + this.oooo + this.llll + this.oooo; break;
