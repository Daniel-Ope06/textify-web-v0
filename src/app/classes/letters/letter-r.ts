...
export class LetterR implements CharacterInterface {
    oooo: string = "    ";
    llll: string = "$$$$";
    ...
    getLine(lineNumber: number): string{
        ...
        switch(lineNumber){
            ...
            case 4: line = this.llll + this.llll + this.oooo + this.oooo; break;
            case 5: line = this.llll + this.llll + this.oooo + this.oooo; break;
