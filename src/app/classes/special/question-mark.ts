...
export class QuestionMark implements CharacterInterface {
    oooo: string = "    ";
    llll: string = "$$$$";
    ...
    getLine(lineNumber: number): string{
        ...
        switch(lineNumber){
            ...
            case 6: line = this.oooo + this.oooo + this.oooo + this.oooo; break;
            case 7: line = this.oooo + this.oooo + this.oooo + this.oooo; break;
